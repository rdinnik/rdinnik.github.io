...
Коственным подтверждением этому служит появление в последнее время целого ряда специализированного ПО для мониторинга контейнеров и микросервисов в задачи которого начало, помимо прочего, входить еще и **_эвристическое_** выявление сложных зависимостей.
