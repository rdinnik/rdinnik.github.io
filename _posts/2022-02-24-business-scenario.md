---
title: "Бизнес-сценарии и бизнес-цели"
---
26.1. Введение
...
Ключевой фактор успеха архитектуры предприятия -- это степень, в которой
она связана с бизнес-требованиями и поддерживает и дает возможность
предприятию достигнуть его бизнес-целей.

Бизнес-сценарии -- это важная технология, которая может использоваться в
различных стадиях архитектуры предприятия, преимущественно в фазах
...
чтобы помочь идентифицировать и понять потребности бизнеса и получить из
...
-   Среду бизнеса и технологии

-   Людей и вычислительные компоненты (называемых \"субъектами\"),
...
значение для организации-клиента разработанного решения.

Хороший бизнес-сценарий также отвечает \"SMART\". Он:
...
![http://lnew39.ru/togaf/practice.enterprise.togaf.togaf-core.base/guidances/concepts/resources/26-01.jpg](media/image1.jpeg){width="5.291666666666667in"
height="3.5625in"}
...
![http://lnew39.ru/togaf/practice.enterprise.togaf.togaf-core.base/guidances/concepts/resources/26-02.jpg](media/image2.jpeg){width="6.239583333333333in"
...
клиента (управление бизнесом плюс архитекторы предприятия) является
...
![http://lnew39.ru/togaf/practice.enterprise.togaf.togaf-core.base/guidances/concepts/resources/26-03.jpg](media/image3.jpeg){width="5.833333333333333in"
height="2.4791666666666665in"}

*Рисунок 26‑3. Относительные вклады в бизнес-сценарий*

Поставщик архитектуры IT может помочь предприятию-заказчику
интегрировать продукты других продавцов в архитектуру предприятия. Эта
...
![http://lnew39.ru/togaf/practice.enterprise.togaf.togaf-core.base/guidances/concepts/resources/26-04.jpg](media/image4.jpeg){width="4.6875in"
...
должны иметь понимание бизнеса, таким образом Вы должны знать самые
важные субъекты в системе. Если заинтересованные лица не знают, что они
хотят:
...
(пользователь) является диспетчером (актор)). Каждый субъект использует
...
-   Подробно зафиксируйте все важные данные о бизнесе-сценарии:
    ...
    -   Все роли субъектов и подизмерения

    -   Все необходимые сервисы

-   Зафиксируйте критические шаги между субъектами, которые разрешают
    ситуацию, и упорядочите взаимодействия

-   Представьте релевантную информацию обо всех субъектах:

    -   Разделение ответственностей среди субъектов
...
-   Нужно помнить цель использования модели:
    ...
    -   Связать субъекты и взаимодействия
...
связан с бизнес-требованиями и поддерживает и дает возможность
предприятию достигать своих бизнес-целей. Бизнес-сценарии -- это важная
технология, которая может использоваться в различных стадиях определения
архитектуры предприятия или любого другого важного IT-проекта для
...
идентифицировать и понять бизнес-потребности и, таким образом, получить
